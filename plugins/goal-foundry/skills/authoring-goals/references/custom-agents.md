...
Codex custom agents are project/user configuration, not automatically installed by this plugin. Goal Foundry includes optional templates under `assets/codex-agents/`:
