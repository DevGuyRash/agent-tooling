...
- [Arranging evidence](references/arranging-evidence.md) for evidence fit, observations, allocation, variation, and stopping.
- [Information and execution](references/information-and-execution.md) for exposure, legitimate context, environments, shared state, and obtaining outcomes.
- [Validity and attribution](references/validity-and-attribution.md) for source truth, instruments, failed outcomes, uncertainty, and causal claims.
- [Presenting evidence](references/presenting-evidence.md) for views that help inspect, discover, decide, or continue.
