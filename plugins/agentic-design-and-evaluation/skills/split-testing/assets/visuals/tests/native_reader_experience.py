...
async def qualify(args):
    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            check('Wide inspector aligns with drawing and receives useful height',geometry['layout']=='side' and abs(geometry['top'])<4 and geometry['height']>=200,geometry)
            ...
            for width in [280,390,760,1440]:
                ...
                if width==390:
                    ...
                    await fig.scroll_into_view_if_needed();await graph.locator('.av-inspector-opener').click();await idle(page)
                    ...
                    await shot(page,'evidence-drawer-mobile');await page.keyboard.press('Escape');check('Evidence reader returns to its originating control',await graph.locator('.av-inspector-opener').evaluate('e=>document.activeElement===e'))
