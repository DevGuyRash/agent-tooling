...
You SHOULD distinguish public shared knowledge, optional adjacent capabilities, and required dependencies. A caller that copies another owner's chapter map or procedure acquires a maintenance dependency even while all file paths resolve. Repair the ownership or delivery relationship and make shared references directly usable by their intended consumers.
