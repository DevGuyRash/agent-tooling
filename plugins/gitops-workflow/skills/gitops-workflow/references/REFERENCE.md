...
This skill follows the Open Agent Tooling format:
...
Install the plugin package from `plugins/gitops-workflow/` when a marketplace
is available. For skill-only installs, copy this bundled skill directory into a
skills-discovery location supported by your agent product, for example:
