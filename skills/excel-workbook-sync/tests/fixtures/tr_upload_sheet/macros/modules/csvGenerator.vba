...
Private Const INVOICES_TABLE_NAME As String = "tbl_invoices"
...
Public Sub GenCSV_ToPath(ByVal zipPath As String, Optional ByVal ShowSuccessMessage As Boolean = True)
    ...
    Set importSets = CollectUniqueImportSets(invoicesWs)
...
Private Function CollectUniqueImportSets(ByVal invoicesWs As Worksheet) As Collection
    ...
    On Error Resume Next
    Set lo = invoicesWs.ListObjects(INVOICES_TABLE_NAME)
    On Error GoTo 0
