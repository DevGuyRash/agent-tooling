...
description: >-
  ...
  involves: (1) Pulling tables, names, conditional formatting, Power Query, or
  VBA metadata from `.xlsx` or `.xlsm` workbooks, (2) Comparing OOXML and
...
compatibility: >-
  ...
  manifest-driven write flows. OOXML pull and compare works portably for
  `.xlsx` and `.xlsm`.
---
...
- Raw and normalized parity both matter. Normalized parity filters clearly
  internal Excel-generated names so user-facing mismatches are easier to see.
