...
fn producer_worker_key(producer_kind: ProducerKind) -> Option<String> {
    match producer_kind {
        ...
        ProducerKind::DomainReviewer => Some(worker_key(WorkerKind::DomainReviewer)),
        ProducerKind::SurfaceMapper => Some(worker_key(WorkerKind::SurfaceMapper)),
        ProducerKind::LanguageDetector => Some(worker_key(WorkerKind::LanguageDetector)),
        ProducerKind::LanguageResearch => Some(worker_key(WorkerKind::LanguageResearch)),
        ...
        ProducerKind::FinalSynthesizer => Some(worker_key(WorkerKind::FinalSynthesizer)),
        ...
        let artifact =
            ArtifactDocument::ApplicationResult(crate::artifacts::ApplicationResultArtifact {
                ...
                dispositions: vec![crate::artifacts::DispositionRecord {
                    ...
                    stop_recommendation: Some("stop".to_string()),
                }],
