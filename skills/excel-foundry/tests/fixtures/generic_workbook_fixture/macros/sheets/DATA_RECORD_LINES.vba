...
Private Sub Worksheet_Deactivate()
    On Error Resume Next
    AP_HandleLinesSheetDeactivate True
    On Error GoTo 0
End Sub
...
Private Sub Worksheet_Change(ByVal Target As Range)
    ...
    Set lo = Me.ListObjects("tbl_record_lines")
    ...
    AP_QueueSyncAll_WithTarget True, changedBottomRow, changedTopRow, changedFirstCol, changedLastCol, protectChangedRows
    Application.OnUndo "Undo last record-lines change", "'" & ThisWorkbook.Name & "'!AP_UndoRecordLinesChange"
