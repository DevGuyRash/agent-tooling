...
$vbaScript = Join-Path $PSScriptRoot "sync-foundry-vba.ps1"
$structureScript = Join-Path $PSScriptRoot "sync-foundry-structure.ps1"
$powerQueryScript = Join-Path $PSScriptRoot "sync-foundry-powerquery.ps1"
